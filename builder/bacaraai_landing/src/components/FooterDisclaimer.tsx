      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-white">AI Baccarat Assistant</span>
          </div>
        ...
        <div className="bg-zinc-900/50 rounded-xl p-6 border border-zinc-800">
          ...
          <p className="text-xs text-zinc-500 leading-relaxed">
            AI Baccarat Assistant는 게임의 결과를 예측하거나 수익을 보장하는 시스템이 아닙니다. 
        ...
        <div className="text-center text-xs text-zinc-600 mt-8">
          &copy; {new Date().getFullYear()} AI Baccarat Assistant. All rights reserved. (Demo Landing Page)
        </div>
      </div>
    </footer>
  );
