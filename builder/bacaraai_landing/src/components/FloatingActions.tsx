...
import { ArrowUp, MessageSquare, LogIn, ArrowRight } from 'lucide-react';
...
export default function FloatingActions() {
  ...
  return (
    <>
      ...
      <div
        className={`hidden md:flex fixed bottom-8 right-8 flex-col gap-3 z-50 transition-all duration-500 ${
