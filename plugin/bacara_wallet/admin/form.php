...
<div class="bacara-wallet">
    <h2>회원 생성 (아이디·비밀번호 부여)</h2>
    <p class="bw-desc">
        사용자 스스로 가입하지 않습니다. 관리자가 아이디와 비밀번호를 만들어 전달하세요.
    </p>
        ...
        <form method="post" action="<?php echo htmlspecialchars(bacara_wallet_admin_url('action.php'), ENT_QUOTES, 'UTF-8'); ?>" autocomplete="off">
            ...
            <div class="bw-grid">
                ...
                <div>
                    ...
                    <input type="text" name="mb_password" id="mb_password" required class="frm_input" minlength="4" placeholder="전달할 비밀번호">
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="bw-hint">예: 4000000 (시드). 0이면 머니 없이 생성</p>
                </div>
            </div>
            ...
            <div class="bw-actions">
                <button type="submit" class="btn_submit bw-amber">회원 생성 + 머니 지급</button>
                <a href="<?php echo htmlspecialchars(bacara_wallet_admin_url(), ENT_QUOTES, 'UTF-8'); ?>" class="btn_frmline">목록으로</a>
            </div>
        </form>
    </div>
</div>
